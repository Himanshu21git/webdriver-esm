...
export const config: WebdriverIOConfig = {
    ...
    serenity: {
        ...
        cueTimeout: new Duration(10000),
        interactionTimeout: new Duration(10000),
    ...
    capabilities: [
        {
            ...
            'goog:chromeOptions': {
                args: [
                    ...
                    '--headless', // Makes browser visible when test are run
                    '--disable-gpu',
    ...
    baseUrl: 'https://local.exampathfinder.com:3000/',
    //
